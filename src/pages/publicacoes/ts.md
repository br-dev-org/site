...
Não é muito fácil de entender qual é o problema se não ler a mensagem completa e de forma linear. E este é apenas um exemplo simples, uma mensagem de erro maior ´. Agora compare com esta visualização:
